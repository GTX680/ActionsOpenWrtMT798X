...
# 强制删除大内存插件
# ==========================================
./scripts/config --unset CONFIG_PACKAGE_python3
./scripts/config --unset CONFIG_PACKAGE_python3-pip
./scripts/config --unset CONFIG_PACKAGE_python3-requests
./scripts/config --unset CONFIG_PACKAGE_ruby
./scripts/config --unset CONFIG_PACKAGE_libruby
./scripts/config --unset CONFIG_PACKAGE_vim-fuller
./scripts/config --unset CONFIG_PACKAGE_vim-help
./scripts/config --unset CONFIG_PACKAGE_vim-runtime
./scripts/config --unset CONFIG_PACKAGE_node
./scripts/config --unset CONFIG_PACKAGE_luci-app-openclash
./scripts/config --unset CONFIG_PACKAGE_luci-app-passwall
./scripts/config --unset CONFIG_PACKAGE_luci-app-passwall2
./scripts/config --unset CONFIG_PACKAGE_aria2
./scripts/config --unset CONFIG_PACKAGE_aria2-openssl
./scripts/config --unset CONFIG_PACKAGE_ariang
./scripts/config --unset CONFIG_PACKAGE_git
./scripts/config --unset CONFIG_PACKAGE_git-http
./scripts/config --unset CONFIG_PACKAGE_bash
./scripts/config --unset CONFIG_PACKAGE_coreutils
./scripts/config --unset CONFIG_PACKAGE_smartmontools
./scripts/config --unset CONFIG_PACKAGE_btrfs-progs
./scripts/config --unset CONFIG_PACKAGE_gawk
./scripts/config --unset CONFIG_PACKAGE_grep
./scripts/config --unset CONFIG_PACKAGE_sed
./scripts/config --unset CONFIG_PACKAGE_nano
./scripts/config --unset CONFIG_PACKAGE_openssl-util
./scripts/config --unset CONFIG_PACKAGE_jq
./scripts/config --unset CONFIG_PACKAGE_yq
./scripts/config --unset CONFIG_PACKAGE_tcpdump
./scripts/config --unset CONFIG_PACKAGE_htop
./scripts/config --unset CONFIG_PACKAGE_mutt
./scripts/config --unset CONFIG_PACKAGE_msmtp

# 清理 Docker 残留
./scripts/config --unset CONFIG_DOCKER_NET_MACVLAN
./scripts/config --unset CONFIG_DOCKER_STO_EXT4
